...
public:
    ...
    QWaylandPointerGesture *pointerGesture() const { return mPointerGesture.data(); }
...
private:
    ...
    QScopedPointer<QWaylandPointerGesture> mPointerGesture;
